...
import { Buffer } from '../common/BufferShim'; // Use Shim
...
export default class VideoSettings {
    ...
    public static fromBuffer(buffer: Buffer): VideoSettings {
        ...
        if (codecOptionsLength) {
            ...
            codecOptions = Util.utf8ByteArrayToString(new Uint8Array(codecOptionsBytes));
        }
        ...
        if (encoderNameLength) {
            ...
            encoderName = Util.utf8ByteArrayToString(new Uint8Array(encoderNameBytes));
        }
