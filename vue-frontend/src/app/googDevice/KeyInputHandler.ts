...
export class KeyInputHandler {
    ...
    private static handler = (event: Event): void => {
        ...
        // We should not prevent default for F5 (reload), F12 (dev tools) usually, but 
        // to prevent typing in other fields or browser shortcuts, we often prevent default.
        // For development, I will only prevent default for keys we mapped.
